...
final class MochiNode: SKSpriteNode {
    ...
    static func make(textureName: String = "mochi_walk_16_clean") -> MochiNode {
    ...
    private func loadWalkTextures(sheetName: String) {
        ...
        walkFrames = (0..<16).map { index in
            let texture = SKTexture(
                rect: CGRect(x: CGFloat(index) * frameWidth, y: 0, width: frameWidth, height: 1.0),
                in: sheet
            )
